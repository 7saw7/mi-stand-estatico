...
export default function ServiceCard({
  ...
  return (
    <div
      className={`${bgColor} rounded-2xl shadow-lg p-6 hover:shadow-2xl transition`}
    >
      ...
      {showButton && (
        <button
          onClick={onClick}
          className={`${variantClass} mt-6 cursor-pointer transition-transform duration-200 text-black px-6 py-3 rounded-full font-semibold hover:bg-black hover:text-white transition-colors duration-300`}
        >
          {buttonText}
        </button>
      )}
